...
#Create a list holding the labels
feeling_list = []
...
#Split each dataframe in two different dataframes containing the features and labels (this will be useful for the CNN later)
...
model_name = 'Tone_Analyzer_Model_Ravdess_Dataset.h5'
...
with open("Tone_Analyzer_Model_Ravdess_Dataset.json", "w") as json_file:
    json_file.write(model_json)
    
#Load json and create model
from keras.models import model_from_json
json_file = open('Tone_Analyzer_Model_Ravdess_Dataset.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)

#Load weights from loaded model
loaded_model.load_weights("saved_models/Tone_Analyzer_Model_Ravdess_Dataset.h5")
...
join_df.to_csv('Predictions_Ravdess_Dataset.csv', index=False)