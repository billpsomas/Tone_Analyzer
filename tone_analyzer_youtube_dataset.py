...
for item in audio_list:
    if item[-6:-4]=='02':
        ...
        feeling_list.append('analytical')
    elif item[-6:-4]=='07':
...
model_name = 'Tone_Analyzer_Model_YouTube_Dataset.h5'
...
with open("Tone_Analyzer_Model_YouTube_Dataset.json", "w") as json_file:
    json_file.write(model_json)
    
#Load json and create model
from keras.models import model_from_json
json_file = open('Tone_Analyzer_Model_YouTube_Dataset.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)

#Load weights into loaded model
loaded_model.load_weights("saved_models/Tone_Analyzer_Model_YouTube_Dataset.h5")
...
join_df.to_csv('Predictions_YouTube_Dataset.csv', index=False)